...
#GET RESULTS WHICH PVALUE <0.05 AND PADJ <0.05
```{r}
...
#PLOT HEATMAP
```{r}
png(filename="TALA-WRITEUP.png", width=900, bg="white")
...
write.csv(res.table, file = paste0('DESeq2_results-tala-res_more_vs_less_res.csv'))
```
...
#MAKE COPY FOR OLA
```{r}
source <- '~/Documents/BIOINFORMATICS MSC/Project/FINAL_FILES/5(TALA)DESEQ_CODE_PROJECT_LESSVSMORE.Rmd'
new <- '~/Documents/BIOINFORMATICS MSC/Project/FINAL_FILES/5(OLA)DESEQ_CODE_PROJECT_LESSVSMORE.Rmd'
